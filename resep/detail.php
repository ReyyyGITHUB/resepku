...
$categoryLabel = trim((string) ($recipe['category'] ?? '')) !== '' ? ucfirst((string) $recipe['category']) : 'Recipe';
...
function detail_format_step_content(string $text, int $index): array
{
    ...
    $numberLabel = 'Step ' . str_pad((string) ($index + 1), 2, '0', STR_PAD_LEFT);
            ...
            <div class="detail-hero__panel">
                <div class="detail-hero__badges">
                    ...
                    <span class="detail-badge">
                        ...
                        <span><?= e(str_replace('servings', 'Portions', $recipe['servings'])) ?></span>
                    </span>
                    <span class="detail-badge">
                        <img class="detail-badge__icon" src="../assets/img/icon-clock.svg" alt="">
                        <span><?= e(str_replace('mins', 'minutes', $recipe['cook_time'])) ?></span>
                    </span>
                    <span class="detail-badge">
            ...
            <aside class="detail-layout__aside">
                ...
                <?php if ($isGuest): ?>
                    <article class="detail-panel detail-panel--guest">
                        ...
                        <p class="detail-panel__text">Login untuk menyimpan resep, memberi like, dan mengirim rating.</p>
                        <button type="button" class="detail-action detail-action--primary detail-action--full" data-guest-gate>Create account</button>
                    </article>
                <?php endif; ?>
            </aside>
